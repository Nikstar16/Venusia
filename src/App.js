      ...
      <div className="px-2 lg:px-24 flex flex-col justify-center">
        ...
        <div className="hidden lg:block lg:relative lg:border-0 lg:w-full lg:mb-24 lg:mt-8">
          ...
          <div className="lg:absolute lg:top-0 lg:w-full lg:flex lg:flex-row lg:items-end border-b-8 border-gray-600 pb-4">
            ...
            <div className="lg:w-1/3 lg:flex lg:flex-row xl:w-1/3 xl:flex xl:flex-row">
              <div className="lg:flex lg:flex-col lg:mr-8 xl:flex xl:flex-row xl:mr-8">
                <div className="lg:flex lg:flex-row">
                  <span className="lg:text-sm lg:text-gray-600 lg:font-bold lg:mr-1 lg xl:text-sm xl:text-gray-600 xl:font-bold xl:mr-1 xl:">Tel:</span> <span className="lg:text-sm lg:font-bold text-primary-blue unselectable xl:text-sm xl:font-bold text-primary-blue unselectable w-max">07810 018 274</span>
                </div>
                <div className="lg:flex lg:flex-row">
